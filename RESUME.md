...
1. **Spec-v2 gate rounds** on findings G1–G5 (`OPEN-PROOFS.md` Phase 0;
   `research_knowledge/gates.md`, gate series v2). G2, the
...
2. **Attestation build** of merged `main` on a machine with resources: a
   ...
   commits (`OPEN-PROOFS.md`, "Attestation debt"). Not a laptop job.
3. **The ranked worklist** in `OPEN-PROOFS.md` Phase 1+ (safety core on
