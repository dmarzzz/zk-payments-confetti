...
\decl{single_signal_hiding} --- the additive, KDM-flavoured key use in
...
\item \textbf{T7 --- exculpability (framing) bound} ---
  ...
  theorem: the development does not formalize an asymptotic
...
compose on one trace; and the whole tree is axiom-clean (K2). T7's
...
hash/signature reductions behind the ideal
...
One-trace composition & \file{Zkpc/Core/Composition.lean} & \decl{channel_endToEnd_composition}, \decl{wire_endToEnd_composition} \\
