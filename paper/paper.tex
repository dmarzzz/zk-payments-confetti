...
guarantee bundles simultaneously on a single reachable trace. The
definition went through eleven rounds of
...
reference wires are. Its Lean formalization (\texttt{Zkpc/Chain/}) targets
...
same boundary as A and B's proofs.
