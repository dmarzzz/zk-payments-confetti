...
\item \textbf{T7 --- exculpability (framing) bound} ---
  ...
  theorem. \file{Zkpc/Games/FrameAsymptotic.lean} lifts it to a negligible
  family when the certified query numerator is polynomially bounded and
  inverse field cardinality is negligible; that scaling bridge does not
  classify adversary runtime as PPT or reduce deployed hash or signature
...
\decl{FrameQueryBounds}; these composition theorems do not add an
asymptotic PPT or deployed-hash claim. Their source contains no
