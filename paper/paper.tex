...
masked cipher, and \file{Zkpc/Crypto/ReceiptMac.lean} proves a $1/|F|$
fresh-message forgery bound for the one-time algebraic receipt MAC
(\decl{mac_forgery_bound}). What remains beyond these
...
Refund crypto references & \file{Zkpc/Crypto/MaskedEncryption.lean}, \file{Zkpc/Crypto/ReceiptMac.lean} & \decl{evalDist_rerandomize_cipher_uniform}, \decl{evalDist_refundUpdate_cipher_uniform}, \decl{mac_forgery_bound} \\
...
Refund fleet aggregation & \file{Zkpc/Refund/Fleet.lean} & \decl{fleet_no_overspend}, \decl{fleet_conservation}, \decl{fleet_payer_floor} \\
