...
| 4.8 | Instantiation C (unidirectional nullifier-chain channel, per-request anonymity, fund-forfeit-only penalties, post-quantum stack): design due to Vitalik Buterin, communicated via dmarzzz; recorded verbatim in-repo; comparison claims (no identity-slash, interactivity trade, hidden balances load-bearing for per-request anonymity) | Primary: https://gist.github.com/dmarzzz/ddcd1302c5f511001f8f46102874a08e; REPO `research_knowledge/vitalik-nullifier-chain-channel.md`; L `Zkpc/Chain/` (formalization) |
