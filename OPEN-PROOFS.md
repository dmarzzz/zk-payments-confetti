# Open proofs — v2 worklist (nullifier-chain protocol)
...
`research_knowledge/proof-inventory-rev11.md`) or are moot under the
...
`research_knowledge/gates.md`, not into a weakened statement.
...
branch's own audit (`research_knowledge/t7-stack-audit-2026-07-10.md`,
