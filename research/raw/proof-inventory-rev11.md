> **Historical (rev-11 object).** This is the proof inventory of the
> superseded `Spec.md` rev-11 formalization as of the PR #2 merge. The
> live worklist for the new design of record (`PROTOCOL.md`) is the
> repository root's `ROADMAP.md`.
...
statement failure is recorded in `gates.md` rather than
...
- `gates.md`: adversarial definition-review record.
