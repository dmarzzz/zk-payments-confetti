...
This section mirrors the specification of record (`../raw/Spec.md` revision 11 in
...
from a verified literature sweep (repository, `../processed/field-report.md`); each cites
...
The specification of record is `../raw/Spec.md` (revision 11); every Lean
...
`../raw/gates.md`. It is not independent human sign-off. The K2
