...
- **R** = `../processed/field-report.md` (the verified field report; section named). Where R
  ...
  primary source").
- **S** = `../raw/Spec.md` revision 11 (section named). The definition section
  mirrors S; S is the trust surface.
- **G** = `../raw/gates.md` (agent-simulated gate round named;
