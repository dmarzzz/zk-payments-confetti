...
[`../raw/gates.md`](https://github.com/dmarzzz/zk-payments-confetti/blob/main/../raw/gates.md).
...
The spec of record is `../raw/Spec.md` (rev 11); the theorem-to-file map is in the
paper's reproducibility section; the gate record with every counterexample
is `../raw/gates.md`; TLA+ models (including ablation configs
