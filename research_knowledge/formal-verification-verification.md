<!-- raw agent output from the 2026-07-06 research sweep (angle: formal-verification, verification); unedited; the verified synthesis is ../RESEARCH.md and supersedes this file where they disagree -->
